    ...
    <div>
      <div className='h-screen w-screen bg-[#f5f5f5]'>
        <div className='w-4/5 h-screen absolute right-0 bg-[#f5f5f5] '>
          ...
          <div className='headinginfoielst text-[#7C3BCF] font-bold flex justify-center text-5xl '>IELTS Information</div>
          ...
          <a href='/study/writing/task2' className='writingtask2btn flex justify-center items-center text-white hover:bg-purple-500 transition-colors duration-500'>Start writing task 2</a>
        </div>
        <Navbar/>
      </div>
    </div>
